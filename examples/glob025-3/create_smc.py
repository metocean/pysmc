...
# Rectangular level2 box around NZ
size2_bbox = np.array([[155, 155, 190, 190, 155], [-55, -25, -25, -55, -55]]).transpose()

# -- 2. gen grid
glbBathy = smc.NCBathy(matFnm, debug=debug)
if genGrid:
    smc.GenSMCGrid(bathy_obj=glbBathy, gen_cell_sides=True, debug=debug,
            exclude_flags='./user_polygons.flag', size2_bbox=size2_bbox)

exit

# -- 3. Create Grid from file and plot the cells
smcFnm = 'GLB025-3Cell.dat'
#obsFnm = 'GLB1DObs.dat'
